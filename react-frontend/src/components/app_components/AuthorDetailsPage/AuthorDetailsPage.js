...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="authorDetails-add-button"/>
                    
                    </>
                </div>
            </div>
            <div className="grid align-items-center">
                <div className="col-11" role="authorDetails-datatable">
...
/>            
      ...
      />
            ...
            <AuthorDetailsCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
