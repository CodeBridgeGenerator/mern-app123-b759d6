...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="reviewDetails-add-button"/>
                    
                    </>
                </div>
            </div>
            <div className="grid align-items-center">
                <div className="col-11" role="reviewDetails-datatable">
...
/>            
      ...
      />
            ...
            <ReviewDetailsCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
