...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="bookDetails-add-button"/>
                    
                    </>
                </div>
            </div>
            <div className="grid align-items-center">
                <div className="col-11" role="bookDetails-datatable">
...
/>            
      ...
      />
            ...
            <BookDetailsCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
