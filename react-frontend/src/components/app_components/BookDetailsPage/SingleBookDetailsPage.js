...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">PublicationDate</label><p id="publicationDate" className="m-0 ml-3" >{_entity?.publicationDate}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">QuantityInStock</label><p className="m-0 ml-3" >{Number(_entity?.quantityInStock)}</p></div>
            <div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">AuthorName</label>
                    {authorName.map((elem) => (
      ...
      <CommentsSection
        recordId={urlParams.singleBookDetailsId}
        user={props.user}
        alert={props.alert}
