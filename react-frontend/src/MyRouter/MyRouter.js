...
import SingleBookDetailsPage from "../components/BookDetailsPage/SingleBookDetailsPage";
import BookDetailProjectLayoutPage from "../components/BookDetailsPage/BookDetailProjectLayoutPage";
import SingleAuthorDetailsPage from "../components/AuthorDetailsPage/SingleAuthorDetailsPage";
import AuthorDetailProjectLayoutPage from "../components/AuthorDetailsPage/AuthorDetailProjectLayoutPage";
import SingleSaleDetailsPage from "../components/SaleDetailsPage/SingleSaleDetailsPage";
import SaleDetailProjectLayoutPage from "../components/SaleDetailsPage/SaleDetailProjectLayoutPage";
import SingleReviewDetailsPage from "../components/ReviewDetailsPage/SingleReviewDetailsPage";
import ReviewDetailProjectLayoutPage from "../components/ReviewDetailsPage/ReviewDetailProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/bookDetails/:singleBookDetailsId" exact element={<SingleBookDetailsPage />} />
<Route path="/bookDetails" exact element={<BookDetailProjectLayoutPage />} />
<Route path="/authorDetails/:singleAuthorDetailsId" exact element={<SingleAuthorDetailsPage />} />
<Route path="/authorDetails" exact element={<AuthorDetailProjectLayoutPage />} />
<Route path="/saleDetails/:singleSaleDetailsId" exact element={<SingleSaleDetailsPage />} />
<Route path="/saleDetails" exact element={<SaleDetailProjectLayoutPage />} />
