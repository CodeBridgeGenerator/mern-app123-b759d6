...
const bookDetails = require("./bookDetails/bookDetails.service.js");
const authorDetails = require("./authorDetails/authorDetails.service.js");
const saleDetails = require("./saleDetails/saleDetails.service.js");
...
module.exports = function (app) {
  ...
  app.configure(bookDetails);
  app.configure(authorDetails);
  app.configure(saleDetails);
