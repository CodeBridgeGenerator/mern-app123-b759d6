    ...
    module.exports = function (app) {
        ...
        const schema = new Schema(
          {
            bookName: { type: String, required: true, unique: false, lowercase: false, uppercase: false, index: false, trim: false },
...
reviewText: { type: String, required: true, unique: false, lowercase: false, uppercase: false, index: false, trim: false },
